...
function library:window()
	...
	function window:notify(args)
		...
		local descr = args.text
		local duration = args.duration

		local Placeholder = notifs.placeholder
		...
		task.delay(args.duration or 4, function()
	...
	function window:addTab(name)
		...
		newButton.MouseButton1Click:Connect(selectTab)
